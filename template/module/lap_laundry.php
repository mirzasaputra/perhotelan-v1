        ...
        <div class="card-body pt-2 pb-2" style="min-height: 400px;max-height: 700px;">
            ...
            <form action="" method="GET">
                <div class="input-group col-md-4 col-sm-6 col-xs-8 ml-auto mr-3 mt-3">
                    ...
                    <input type="hidden" name="module" value="lap_laundry">
            ...
            <a href="template/cetak.php?cetak=transaksi_laundry&month=<?=$month;?>&years=<?=$years;?>" target="_blank" class="btn btn-secondary float-right mt-3 mb-4 mr-5"><i class="fas fa-print"></i> Cetak</a>
            ...
            <div class="table-responsive mt-4">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <?php endforeach;?> 
                        <?php $query = mysqli_query($conn, "SELECT SUM(total) as total FROM transaksi_laundry");$total = mysqli_fetch_array($query);?>
                    </tbody>
                    <tfooter>
                        <tr>
