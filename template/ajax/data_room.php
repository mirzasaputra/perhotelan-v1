...
$result = mysqli_query($conn, "SELECT transaksi_kamar_detail.*, kamar.*, tipe_kamar.* FROM transaksi_kamar_detail, kamar, tipe_kamar WHERE kamar.id_kamar=transaksi_kamar_detail.id_kamar && tipe_kamar.id_tipe_kamar=kamar.id_tipe_kamar && transaksi_kamar_detail.id_transaksi_kamar='$id'");
    ...
    <tbody>
        <?php if(mysqli_num_rows($result) > 0) { ?>
            ...
            <tr>
                ...
                <td width="1%" class="text-center"><button class="btn btn-danger action" data-toggle="delete" data-id="<?=$i['id_transaksi_kamar_detail'];?>"><i class="fas fa-times"></i></button></td>
            </tr>
            <?php endforeach;?>
        <?php } else { ?>
            <tr>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="proses/tambah.php?room&&id=<?=$_GET['id_transaksi'];?>" method="post" id="formRoom">
