...
if(isset($_GET['check_in'])){
    ...
    if($inap < 0){
        ...
        $query = mysqli_query($conn, "INSERT INTO transaksi_kamar VALUES('$id_transaksi', '$no_invoice', '$tgl', '$id_tamu', null, null, null, '$tgl_checkin', '$waktu_checkin', '$tgl_checkout', '$waktu_checkout', '$total_biaya', '', 0, '$deposit', '', '', 'check in')");
